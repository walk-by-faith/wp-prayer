...
$form->add_element( 'checkbox', 'wpe_social', array(

	'current' => (isset( $data['wpe_social'] ) and ! empty( $data['wpe_social'] )) ? $data['wpe_social'] : '',
	'desc' => __( 'Social media share button', WPE_TEXT_DOMAIN ),
	'class' => 'form-control ',
	'before' => '<div class="col-md-6">',
	'after' => '</div>',
	'value' => 'true',
